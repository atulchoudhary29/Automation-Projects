...
class InstagramBot:
    ...
    def nav_user(self, user):
        ...
        self.driver.get('https://www.instagram.com/explore/tags/' + user)
    ...
    def like_user_post(self, user, limit):
        try:
            self.nav_user(user)
            ...
            for _ in range(limit):
                ...
                try:
                    self.driver.find_element_by_xpath("/html/body/div[6]/div[3]/div/article/div/div[2]/div/div/div[2]/section[1]/span[1]/button/div[1]").click() 
                except:
                    self.driver.find_element_by_xpath("/html/body/div[6]/div[3]/div/article/div/div[2]/div/div/div[2]/section[1]/span[1]/button/div[2]").click()
                sleep(self.random_number_generator(2, 5))
                #like_btn.click()
                #next_btn = self.driver.find_element_by_xpath("//a[contains(text(), 'Next')]")
                #next_btn = self.driver.find_element_by_xpath("/html/body/div[6]/div[2]/div/div/button/div")
                try:
                    self.driver.find_element_by_xpath("/html/body/div[6]/div[2]/div/div/button/div").click() 
                except:
                    self.driver.find_element_by_xpath("/html/body/div[6]/div[2]/div/div[2]/button/div").click()
...
if __name__ == "__main__":
    ...
    bot = InstagramBot('its.choudhary.not.atul','Atulthehacker')
    #bot.nav_user('lilbaby')
    bot.like_user_post('lilbaby',5)